...
use App\Http\Requests\CategoryRequest;//paso2
use App\Category;//paso2.1
use Laracasts\Flash\Flash;//paso2.2
...
class CategoriesController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CategoryRequest $request)//paso3
    {
